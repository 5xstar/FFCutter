...
*播放器超类 
**/
public abstract class VLCJPlayerBase extends PlayerAbstractImpl {
     ...
     */
    private static final String NATIVE_LIBRARY_SEARCH_PATH =  File.separator+"VLC";  //"/usr/lib64/vlc";   //VLC安装目录for window
    ...
    static {
        //加载
        //System.loadLibrary(NATIVE_LIBRARY_SEARCH_PATH);
